    ...
    public class VetsDB : DbContext // DbContext sabe interagir com a BD
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Veterinarios>().HasData(
               new Veterinarios { ID = 1, Nome = "Maria Pinto", NumCedulaProf = "vet-034589", Foto = "Maria.jpg" },
               new Veterinarios { ID = 2, Nome = "Ricardo Ribeiro", NumCedulaProf = "vet-034590", Foto = "Ricardo.jpg" },
               new Veterinarios { ID = 3, Nome = "José Soares", NumCedulaProf = "vet-056732", Foto = "Jose.jpg" }
               );
